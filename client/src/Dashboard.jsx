...
function Dashboard() {
  ...
  const handleCheck = async (monitor, e) => {
      ...
      try {
          const res = await fetch(`http://localhost:3000/monitors/${monitor.id}/check`, { method: 'POST' });
            ...
            <div className="space-y-2">
                ...
                {monitors.map(monitor => (
                    <Link 
                        ...
                        key={monitor.id} 
                        className="bg-[#161b22] border border-gray-800 hover:border-gray-600 rounded-lg p-4 flex items-center justify-between transition-colors group block"
                    >
                            ...
                            {/* Screenshot Thumbnail - Only for Visual Type */}
                                 ...
                                 <div 
                                    ...
                                    onClick={(e) => {
                                        ...
                                        if (monitor.last_screenshot) {
                                            window.open(`http://localhost:3000/static/screenshots/${monitor.last_screenshot.split('/').pop()}`, '_blank');
                                        }
                                    }}
                                 >
                                     {monitor.last_screenshot ? (
                                         <img 
                                            src={`http://localhost:3000/static/screenshots/${monitor.last_screenshot.split('/').pop()}`} 
                                            alt="Monitor" 
                             ...
                             <div className="min-w-0 flex flex-col gap-1">
                                <div className="flex items-center gap-2">
                                    ...
                                    <h3 className="text-white font-bold text-lg truncate" title={monitor.name || monitor.url}>
                        ...
                        <div className="flex items-center gap-6">
                                ...
                                <div className="text-xs text-gray-400 mt-2 flex items-center gap-4 justify-end">
